...
Source0  : http://archive.xfce.org/src/xfce/xfce4-session/4.13/xfce4-session-4.13.3.tar.bz2
...
%prep
%setup -q -n xfce4-session-4.13.3
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1562017045
