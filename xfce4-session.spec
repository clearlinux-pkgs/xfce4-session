...
Version  : 4.14.1
Release  : 25
URL      : http://archive.xfce.org/src/xfce/xfce4-session/4.14/xfce4-session-4.14.1.tar.bz2
Source0  : http://archive.xfce.org/src/xfce/xfce4-session/4.14/xfce4-session-4.14.1.tar.bz2
...
%prep
%setup -q -n xfce4-session-4.14.1
cd %{_builddir}/xfce4-session-4.14.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579908708
...
cp %{_builddir}/xfce4-session-4.14.1/COPYING %{buildroot}/usr/share/package-licenses/xfce4-session/5405311284eab5ab51113f87c9bfac435c695bb9
%make_install
