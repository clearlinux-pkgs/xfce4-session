...
Source0  : http://archive.xfce.org/src/xfce/xfce4-session/4.13/xfce4-session-4.13.4.tar.bz2
...
%prep
%setup -q -n xfce4-session-4.13.4
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1564972286
