...
Source0  : https://archive.xfce.org/src/xfce/xfce4-session/4.18/xfce4-session-4.18.2.tar.bz2
...
%prep
%setup -q -n xfce4-session-4.18.2
cd %{_builddir}/xfce4-session-4.18.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1680726432
